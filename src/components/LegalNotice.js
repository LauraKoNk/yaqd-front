        ...
        <main className="mx-16">
            ...
            <div className="mx-3 mb-10">
                <ul>
                    ...
                    <li>- Conformément au Règlement Général sur la Protection des Données (RGPD), les utilisateurs peuvent demander la suppression de leurs données personnelles par mail à l’adresse : <a className="hover:underline" href="mailto:l.kokonyange@gmail.com">l.kokonyange@gmail.com</a></li>
                </ul>
            </div>
            <div className="mb-10">
